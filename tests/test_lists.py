...
def test_update_list(new_list, custom_api_key, custom_api_token):
    ...
    update_list = data_lists.update_list(new_list['id'], new_data_for_list, custom_api_key, custom_api_token)
...
def test_create_list(custom_api_key, custom_api_token):
    ...
    create_list = data_lists.create_list(data_for_list, custom_api_key, custom_api_token)
...
def test_unarchive_list(new_list, custom_api_key, custom_api_token):
    ...
    archived_list = data_lists.archive_a_list(new_list['id'], archive_value, custom_api_key, custom_api_token)
    unarchive_value = {'closed': 'false'}
    unarchived_list = data_lists.archive_a_list(archived_list.json()['id'], unarchive_value, custom_api_key, custom_api_token)
